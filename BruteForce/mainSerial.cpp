// Brute Force SERIAL S392371

/**
 * @file mainMPI.cpp
 * @brief Serial implementation of the Brute Force algorithm using MPI
...
int min_distance = INT_MAX; // minimum distance
std::vector<int> min_path; // minimum path
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "BRUTE FORCE SERIAL" << std::endl;
